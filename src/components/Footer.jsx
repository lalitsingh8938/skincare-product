...
export default function Footer() {
  return (
    <footer className="bg-[#F7F2EE] text-black py-16">
      {/* MAIN GRID */}
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 px-6 text-sm">
        ...
        <div>
          ...
          <p className="leading-relaxed text-black transition cursor-pointer">
        ...
        {/* Resources */}
        <div>
          <h3 className="text-black font-semibold text-lg mb-3">Resources</h3>
        ...
        {/* Legal */}
        <div>
          <h3 className="text-black font-semibold text-lg mb-3">Legal</h3>
          <ul className="space-y-2 text-black">
            <li className="cursor-pointer hover:text-gray-700">
              Privacy Policy
            </li>
        ...
        <div>
          ...
          <p className="mt-2 font-semibold text-black">contact@ust.com</p>
        </div>
      </div>
